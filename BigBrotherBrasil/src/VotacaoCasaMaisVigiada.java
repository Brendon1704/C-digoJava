...
public class VotacaoCasaMaisVigiada {
    ...
    public static void votacao(ArrayList<Jogador> jogadores) {
        ...
        System.out.println("Inicio das fotação. Digite o nome do participante que você quer eliminar ou 'sair' para encerrar:");
    ...
    public static void apuracaoFinal(ArrayList<Jogador> jogadores) {
        ...
        System.out.println("Se eu conseguir mover montanhas, " +
                "se eu conseguir surfar um tsunami, " + "\n"
                ...
                + eliminado.getVotos() + " votos, é você quem sai " + eliminado.getNome());
    }
}
